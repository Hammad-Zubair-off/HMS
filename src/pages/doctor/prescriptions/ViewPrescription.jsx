    ...
    return (
      <div className="dashboard-container flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/doctor/prescriptions" className="btn btn-primary btn-md mt-4 inline-flex items-center gap-2">
        ...
        <div className="nav-bar-content">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">View prescription information</p>
            </div>
          </div>
          <div className="nav-bar-user flex items-center gap-2">
            <Link to="/doctor/prescriptions" className="btn btn-outline rounded-lg btn-md inline-flex items-center gap-2">
              <ArrowLeft className="w-4 h-4" />
              <span>Back to Prescriptions</span>
            </Link>
            <button type="button" onClick={handleViewPDF} className="btn btn-secondary rounded-lg btn-md inline-flex items-center gap-2">
              <FileText className="w-4 h-4" />
              <span>View PDF</span>
            </button>
            <button type="button" onClick={handlePrint} className="btn btn-primary rounded-lg btn-md inline-flex items-center gap-2">
              <Printer className="w-4 h-4" />
              <span>Print</span>
            </button>
            <button type="button" onClick={handleDownload} className="btn btn-secondary rounded-lg btn-md inline-flex items-center gap-2">
